...
class LlamaCppGenAI:
    def __init__(self, base_url: Optional[str] = None, api_key: Optional[str] = None):
        ...
        Args:
            base_url: URL to the llama.cpp server. Defaults to env var LLAMA_CPP_URL 
                      or "http://localhost:8080/v1/chat/completions".
            api_key: Optional API key if the server is protected. Defaults to env var LLAMA_CPP_KEY.
        """
        # Default to the OpenAI-compatible endpoint provided by llama.cpp
        default_url = "http://localhost:8080/v1/chat/completions"
        
        self.base_url = base_url or os.getenv("LLAMA_CPP_URL", default_url)
        self.api_key = api_key or os.getenv("LLAMA_CPP_KEY", "")
