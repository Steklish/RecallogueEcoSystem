...
class QwenGenAI:
    ...
    def complete(self,
        ...
        try:
            ...
            print(f"{INFO_COLOR}Response from {self.__class__.__name__}:{RESET} {content}")
            ...
            print(f"{ERROR_COLOR}Error during Qwen model API call: {e}{RESET}")
            ...
            print(f"{ERROR_COLOR}Unexpected error during Qwen model call: {e}{RESET}")
